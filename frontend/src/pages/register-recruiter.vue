          ...
          <div class="row justify-content-center">
            <div class="col-md-4">
              <div class="text-center">
                ...
                <p class="font-sm text-muted mb-30">Join <span class="font-sm text-brand-2">InternsifyMe</span> as a Recruiter</p>
              </div>
              ...
              <form class="login-register text-start mt-20" @submit.prevent="register">
                ...
                <div class="form-group">
                  <button class="btn btn-brand-1 hover-up w-100" :disabled="is_loading || form.password.length < 8" type="submit" name="Register">
